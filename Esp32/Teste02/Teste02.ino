      ...
      if (client.available()) {       // se houver bytes para ler do cliente,
        ...
        if (c == '\n') {              // se o byte for um caractere de nova linha
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("<a href=\"/T5\">Sensor. </a> </br></br></br>");
        ...
        //if(currentLine.endWith("GET/T5")){ // Primeira lógica para o sensor
        //digitalRead(Sensor);
        //delay(2000); //Espera 2 segundos, se a peça não apresentar nivel lógico alto.
        //if(Sensor == 0){
        //Peça apresenta defeito; //A peça está com defeito
        //}
      }
